...
var yespower_wasm = (() => {
  var _scriptName = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('worker.cjs', document.baseURI).href));
  return async function(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      var require$1 = createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('worker.cjs', document.baseURI).href)));
    }
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      if (!(typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('worker.cjs', document.baseURI).href)).startsWith("data:")) {
        scriptDirectory = nodePath.dirname(require$1("url").fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('worker.cjs', document.baseURI).href)))) + "/";
      }
      readBinary = (filename) => {
    ...
    function findWasmBinary() {
      ...
      return new URL("yespower_wasm.wasm", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('worker.cjs', document.baseURI).href))).href;
    }
...
function randomNonce() {
  return BigInt(bytesToHex(crypto.webcrypto.getRandomValues(new Uint8Array(63))));
}
